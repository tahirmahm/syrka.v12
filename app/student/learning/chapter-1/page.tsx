  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-5 lg:grid-cols-[220px_minmax(0,1fr)_300px]">
        {/* Chapter and lesson navigator */}
        <nav aria-label="Chapter navigator" className="flex flex-col gap-3 lg:sticky lg:top-20 lg:self-start">
          <div>
        ...
        {/* Learning Intelligence inspector */}
