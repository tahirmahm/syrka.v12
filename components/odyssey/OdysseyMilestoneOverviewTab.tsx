...
export interface OdysseyMilestoneOverviewTabProps {
  resolved: ResolvedOdysseyMilestone
}

function passportImplication(resolved: ResolvedOdysseyMilestone): string {
  if (resolved.expectedImpacts.length === 0) return 'No direct effect on your Syrka Career Passport is projected for this milestone.'
...
/** Everything the compact roadmap node can't show at-a-glance — what, why, prerequisites, action, effort, Evidence, impact, blockers, alternatives, unlocks, Passport implication, review requirement. */
export function OdysseyMilestoneOverviewTab({ resolved }: OdysseyMilestoneOverviewTabProps) {
  ...
  return (
    <div className="flex flex-col">
      ...
      <Section title="Syrka Career Passport implication">
